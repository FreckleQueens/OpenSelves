...
## 📝 Current features
- 🗺 System mapping (still lacks advanced features compared to Simply Plural)
- 👥 Front tracking
- 📶 Offline use with local-first sync (still needs an account)
...
## 🚧 Planned features
- 🗺 System mapping with Simply Plural parity
...
- GitHub issues
- Via email https://openselves.org (click the link under "Contact" at the bottom of the page)

If you are a developer, please read the (very short) [contributing guidelines](CONTRIBUTING.md) before submitting pull
requests.

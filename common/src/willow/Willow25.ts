import { Ed25519, Ed25519Pk, Ed25519Signature } from "./Ed25519.js";
...
export class Willow25 {
	...
	public static readonly DEFAULT_AUTHORISATION_TOKEN_SIGNATURE: Ed25519Signature = new Uint8Array(
		[
			42, 201, 58, 210, 193, 63, 237, 182, 150, 52, 93, 186, 198, 231, 18, 84, 233, 156, 180,
			68, 229, 232, 27, 145, 111, 202, 8, 120, 240, 168, 169, 147, 43, 209, 164, 232, 70, 225,
			202, 131, 55, 123, 116, 10, 41, 184, 87, 10, 133, 3, 141, 80, 102, 43, 168, 175, 102,
			229, 104, 60, 147, 82, 20, 1,
		],
	);
}
